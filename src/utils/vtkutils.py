...
def vtk_extract_boundary_surfaces(
    ...
    thres.SetInputArrayToProcess(
        0, 0, 0, vtk.vtkDataObject.FIELD_ASSOCIATION_CELLS, "cell"
    )
    ...
    thresv.SetInputArrayToProcess(
        0, 0, 0, vtk.vtkDataObject.FIELD_ASSOCIATION_POINTS, "side"
    )
